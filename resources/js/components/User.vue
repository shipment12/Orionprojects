    ...
    <div class="container">
       <div class="row mt-5" v-if="$gate.isAdmin()">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-aqua" style="background-color:aqua; color:white">
            <div class="inner">
              <h3>1</h3>
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green" style="background-color:green; color:white">
            <div class="inner">
              <h3 >2</h3>
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-yellow" style="background-color:yellow; color:white">
            <div class="inner">
              <h3> {{computeAdUsers}}</h3>
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-red" style="background-color:red; color:white">
            <div class="inner">
              <h3>{{(computeUsers)}}</h3>
...
<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="form-group row">
      ...
      <select class="form-control" id="country"  v-model="form.country" :class="{ 'is-invalid': form.errors.has('country')}"   placeholder="Country" type="text" name="country"  required autofocus>
...
import Underscore from 'underscore/underscore.js';
    export default {
        ...
        computed:{
      computeUsers(){
            return _.size(this.users.data)
          },

      computeAdUsers(){
        // console.log(this.userscount())
            return _.size(this.users.type)
          }
    },
